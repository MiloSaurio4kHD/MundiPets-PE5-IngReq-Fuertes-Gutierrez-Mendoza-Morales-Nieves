...
artificial intelligence requirements, MundiPets.
	...
	el \textbf{30 de agosto de 2026}, asociada al commit \texttt{e0d0545} del
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{
			...
			\hline
			\emph{Commit} asociado (hash corto) & \texttt{e0d0545} \\
			\hline
...
\texttt{e0d0545} correspondiente a la versión 4.0 del ERS, congelada el
